...
public class ClienteFrame extends javax.swing.JFrame {
    ...
    public void cargarReservas(DefaultTableModel modelo) {
     ...
     reservaController.cargarReservasPorCliente(modeloReserva);
}
    ...
    private void initComponents() {
        ...
        jPanel11Layout.setVerticalGroup(
            jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(JscPlatos, javax.swing.GroupLayout.DEFAULT_SIZE, 635, Short.MAX_VALUE)
        );
        ...
        jPanel1.add(tabbedCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 0, 1010, 670));
...
// TODO add your handling code here:
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        List<Reserva> reservas = controller.buscarReservaPorEmail(email);
        
          if (!reservas.isEmpty()) {
            Reserva r = reservas.get(0); // suponemos una sola
            ...
            txtEmailBuscar.setText(r.getEmail());
