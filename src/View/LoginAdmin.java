...
public class LoginAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Password.setText("Contraseñacontraseña");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(User, javax.swing.GroupLayout.DEFAULT_SIZE, 356, Short.MAX_VALUE)
    ...
    private void IngresarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_IngresarMouseClicked
        ...
        String AdminUser = usertxt.getText().trim();
        String Adminpassword = new String(passtxt.getPassword()).trim();
        
        if(AdminUser.equals(ADMINUSER)&& Adminpassword.equals(ADMINPASSWORD)){
        ...
        boolean autenticar = controller.autenticarUsuario(usuario, contraseña);
               
        
        if(autenticar){
            int id_usuario = controller.obtenerIdUsuario(usuario, contraseña);
            LoginController.setIdUsuario(id_usuario);
             new PrincipalAdmin().setVisible(true);
         this.dispose();
        }else{
...
// TODO add your handling code here:
    ...
    Ingresar.setBackground(new Color(153,153,153));        
// TODO add your handling code here:
    ...
    private void IngresarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_IngresarMouseExited
         Ingresar.setBackground(new Color(204,204,204));
// TODO add your handling code here:
